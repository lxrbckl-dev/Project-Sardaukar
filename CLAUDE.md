...
| Embedded mode | `--embedded` flag on deploy | HARDCORE session focus: ticket/board suppression + every message presumed about spawning repo + shipping verbs = direct commit to `main` (no branch/PR). Orthogonal to `--skip-qa` |
