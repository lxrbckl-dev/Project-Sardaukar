...
| Embedded mode | `--embedded` flag on deploy | Session-wide suppression of tickets and board writes; spawning repo is the default target for ambiguous asks; orthogonal to `--skip-qa` |
